import { Item, Rarity, Brand } from "./items";

export const exotics : Item[] = [
    {type:`Assault Rifle`,name:`The Bighorn`,talent:`Talent: Big Game Hunter
    ...
    5% chance to drop from one named enemy on legendary boss floors of The Summit. (floor 10, 20, 30, etc.)`,alternateSource:``,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Assault Rifle`,name:`Eagle Bearer`,talent:`Talent: Eagle's Strike
    ...
    Muzzle: +15% Critical Hit Damage`,uniqueSource:`10% chance to drop from the Dark Hours raid chest.`,alternateSource:`- Any Dark Hours raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Assault Rifle`,name:`Chameleon`,talent:`Talent: Adaptive Instincts
    ...
    ,{type:`Assault Rifle`,name:`Capacitor`,talent:`Talent: Capacitance
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Light Machine Gun`,name:`Bullet King`,talent:`Talent: Bullet Hell
    ...
    - End of mission reward
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Light Machine Gun`,name:`Pestilence`,talent:`Talent: Plague of the Outcasts
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Marksman Rifle`,name:`Mantis`,talent:`Talent: In Plain Sight
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Marksman Rifle`,name:`Nemesis`,talent:`Talent: Electromagnetic Accelerator
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Pistol`,name:`Regulus`,talent:`Talent: Regicide
    ...
    - Any Iron Horse raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Pistol`,name:`Liberty`,talent:`Talent: Libery or Death
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Rifle`,name:`The Ravenous`,talent:`Talent: Geri and Freki
    ...
    Magazine: +10% Reload Speed
    Underbarrel: +10% Stability
    Muzzle: +5% Critical Hit Damage`,uniqueSource:`10% chance to drop from the Iron Horse raid chest.`,alternateSource:`- Any Iron Horse raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Rifle`,name:`Diamondback`,talent:`Talent: Agonizing Bite
    ...
    - End of mission reward
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Rifle`,name:`Merciless/Ruthless`,talent:`Talent: Binary Trigger
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Shotgun`,name:`Scorpio`,talent:`Talent: Septic Shock
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Shotgun`,name:`Sweet Dreams/Lullaby`,talent:`Talent: Sandman
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Submachine Gun`,name:`Backfire`,talent:`Talent: Payment in Kind
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Submachine Gun`,name:`Lady Death`,talent:`Talent: Breathe Free
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Submachine Gun`,name:`The Chatterbox`,talent:`Talent: Incessant Chatter
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Backpack`,name:`Acosta's Go-Bag`,talent:`Talent: One in Hand...
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Backpack`,name:`Memento`,talent:`Talent: Kill Confirmed
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Chest`,name:`Ridgeway's Pride`,talent:`Talent: Bleeding Edge
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Chest`,name:`Tardigrade Armor System`,talent:`Talent: Ablative Nano-Plating
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Gloves`,name:`BTSU Datagloves`,talent:`Talent: Transference Overclock
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Holster`,name:`Dodge City Gunslinger's Holster`,talent:`Talent: Quick Draw
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Holster`,name:`Imperial Dynasty`,talent:`Talent: Dragon's Glare
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Holster`,name:`Waveform`,talent:`Talent: Alternating Current
    ...
    - End of mission reward
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Kneepads`,name:`NinjaBike Messenger Kneepads`,talent:`Talent: Parkour!
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Kneepads`,name:`Sawyer’s Kneepads`,talent:`Talent: Stand Your Ground
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Mask`,name:`Coyote’s Mask`,talent:`Talent: Pack Instincts
    ...
    - Any raid boss on characters first clear of the week`,rarity:Rarity.exotic,brand:Brand.none}
    ,{type:`Mask`,name:`Vile`,talent:`Talent: Toxic Delivery
